...
*********************
*
So, in above case, for myEvery() - which is exact same implementation of the isPrime() - the whole function will stop executing furthere as soon as the first 'return' word is encountered. So, I want to make it such a way, that as soon any of the elements fails the test in the callback, I return from the function by returning false.
