...
// A) Human is a instantiation of Animal, like a sub-class of Animal
function Human() {
...
// B) Create the prototype of the derived function ( Human) , based on the base function ( Animal ). To do that, *hard* copy the prototype of the base class. There's two ways to do this, the commented out line below could also have been used.
